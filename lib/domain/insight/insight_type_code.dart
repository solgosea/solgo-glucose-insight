enum InsightTypeCode {
  ...
  glucoseEventsCount('glucose_events_count'),
  glucoseEventsShortcutNoHigh('glucose_events_shortcut_no_high'),
  glucoseEventsShortcutNoLow('glucose_events_shortcut_no_low'),
  glucoseEventsNoData('glucose_events_no_data'),
