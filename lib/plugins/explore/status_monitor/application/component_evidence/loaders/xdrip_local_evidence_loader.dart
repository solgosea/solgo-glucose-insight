...
class XdripLocalEvidenceLoader
    implements StatusComponentEvidenceLoader<XdripLocalEvidence> {
  final StatusMonitorTargetResolution? resolution;
  final DateTime now;

  const XdripLocalEvidenceLoader({
    required this.resolution,
    required this.now,
  });

  @override
  Future<XdripLocalEvidence> load() async {
