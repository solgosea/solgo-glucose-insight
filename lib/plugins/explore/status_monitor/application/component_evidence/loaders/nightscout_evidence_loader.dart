...
class NightscoutEvidenceLoader
    implements StatusComponentEvidenceLoader<NightscoutEvidence> {
  final StatusMonitorTargetResolution? resolution;
  final DateTime now;

  const NightscoutEvidenceLoader({
    required this.resolution,
    required this.now,
  });

  @override
  Future<NightscoutEvidence> load() async {
