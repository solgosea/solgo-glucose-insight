...
class HighEpisodeReportPreviewController extends ChangeNotifier {
  ...
  final HighEpisodeReportPdfRenderer pdfRenderer;
  ...
  HighEpisodeReportPreviewController({
    ...
    this.pdfRenderer = const HighEpisodeReportPdfRenderer(),
  ...
  Future<void> load({Locale? locale}) async {
    ...
    try {
      ...
      final baseContext = HighEpisodeReportProvider.defaultContext(
        intent: intent,
  ...
  ReportRuntime _runtime() {
    return ReportRuntime(
      provider: HighEpisodeReportProvider(
        intent: intent,
        service: service,
