...
import 'low_episode_report_preview_error.dart';
import 'low_episode_report_preview_top_bar.dart';
import 'low_episode_report_sheet.dart';

class LowEpisodeReportPreviewBody extends StatelessWidget {
  final LowEpisodeReportPreviewController controller;
  ...
  const LowEpisodeReportPreviewBody({
    super.key,
          ...
          children: [
            Padding(
              ...
              child: ConstrainedBox(
                ...
                child: LowEpisodeReportPreviewTopBar(
                  exporting: exporting,
                  onBack: onBack,
