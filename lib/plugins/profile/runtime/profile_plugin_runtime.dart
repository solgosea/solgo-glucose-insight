...
import '../application/profile_runtime_refresh_policy.dart';
import '../application/profile_snapshot_preheater.dart';
import 'profile_runtime_cache.dart';

class ProfilePluginRuntime implements PluginRuntime {
  static const id = PluginId('core.profile');

  final ProfileRuntimeCache cache;
  final ProfileSnapshotPreheater preheater;
  final ProfileRuntimeRefreshPolicy refreshPolicy;
  ...
  ProfilePluginRuntime({
    ...
    this.refreshPolicy = const ProfileRuntimeRefreshPolicy(),
  });
